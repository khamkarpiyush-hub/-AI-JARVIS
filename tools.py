...
async def current_time(
    ...
    try:
        ...
        logging.info(f"Current time in {timezone}: {current_time_str}")
        return current_time_str
    except Exception as e:
        logging.error(f"Error retrieving current time for timezone '{timezone}': {e}")
        return f"An error occurred while retrieving current time for timezone '{timezone}'."

@function_tool()
async def web_autoopener(
    context: RunContext,  # type: ignore
    url: str) -> str:
    """
